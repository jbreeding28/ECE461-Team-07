...
data = load('NewFeatureData_1_18_2017.mat');
...
%    data.FifthHighestFrequencyValue, 'VariableNames', data.VariableNames)
 ...
 T = table(data.ClassNumber,data.SourceFile, data.SourceFileChannel,...
    data.SpectrumCentroid, data.SpectrumCentroidValue,...
    data.DominantFrequency, data.DominantFrequencyValue,...
    data.SecondHighestFrequency, data.SecondHighestFrequencyValue,...
    data.ThirdHighestFrequency, data.ThirdHighestFrequencyValue,...
    data.FourthHighestFrequency, data.FourthHighestFrequencyValue,...
    data.FifthHighestFrequency, data.FifthHighestFrequencyValue,...
    data.Percentages, data.STZCR(:,1), data.AverageSTZCR, data.ZCR,...
    data.STEnergy(:,1), data.AverageSTE, data.Energy,...
    data.SpectrumFlux(:,1), 'VariableNames', data.VariableNames)
